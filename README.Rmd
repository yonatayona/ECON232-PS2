...
$$
\text{log}(C_t) = \beta_1 + \beta_2\text{log}(Y_t) + \beta_3\text{log}(C_{t-1}) + \epsilon
$$
...
$$
\begin{aligned}
C_t &= \text{real consumption expenditure}, \\
Y_t &= \text{real disposable personal income}, \\
\delta &= \frac{\beta_2}{1 - \beta_3} \qquad \text{(long-run MPC)}
\end{aligned}
$$
...
\begin{aligned}
H_0:\ \delta = 1
&\implies \frac{\beta_2}{1 - \beta_3} = 1
\\
